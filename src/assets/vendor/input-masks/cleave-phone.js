! function() {
    function l(l, n) {
        var u = l.split("."),
            d = Z;
        u[0] in d || !d.execScript || d.execScript("var " + u[0]);
        for (var $; u.length && ($ = u.shift());) u.length || void 0 === n ? d = d[$] ? d[$] : d[$] = {} : d[$] = n
    }

    function n(l, n) {
        function u() {}
        u.prototype = n.prototype, l.M = n.prototype, l.prototype = new u, l.prototype.constructor = l, l.N = function(l, u, d) {
            for (var $ = Array(arguments.length - 2), t = 2; t < arguments.length; t++) $[t - 2] = arguments[t];
            return n.prototype[u].apply(l, $)
        }
    }
    ...
    function C(l, n) {
        for (var u = i(l.j()), d = 0; d < u.length; d++) {
            var $ = u[d],
                t = $.b;
            if (null != n.a[t]) {
                l.b && delete l.b[$.b];
                var e = 11 == $.a || 10 == $.a;
                if ($.g)
                    for (var $ = s(n, t) || [], r = 0; r < $.length; r++) {
                        var a = l,
                            o = t,
                            f = e ? $[r].clone() : $[r];
                        a.a[o] || (a.a[o] = []), a.a[o].push(f), a.b && delete a.b[o]
                    } else $ = s(n, t), e ? (e = s(l, t)) ? C(e, $) : h(l, t, $.clone()) : h(l, t, $)
            }
        }
    }
    ...
    function s(l, n) {
        ...
        if (l.g) {
            if (!(n in l.b)) {
                ...
                if (null != u)
                    if ($.g) {
                        for (var t = [], e = 0; e < u.length; e++) t[e] = d.b($, u[e]);
                        u = t
                    } else u = d.b($, u);
                return l.b[n] = u
            }
    ...
    function g(l, n) {
        var u, d = [];
        for (u in n) 0 != u && d.push(new a(u, n[u]));
        return new r(l, d)
    }
    /*
    ...
    */
    ...
    function E(l) {
        this.H = RegExp(" "), this.C = "", this.m = new u, this.w = "", this.i = new u, this.u = new u, this.l = !0, this.A = this.o = this.F = !1, this.G = y.b(), this.s = 0, this.b = new u, this.B = !1, this.h = "", this.a = new u, this.f = [], this.D = l, this.J = this.g = v(this, this.D)
    }
    ...
    function v(l, n) {
        ...
        return u = N(l.G, B(u)), null != u ? u : el
    }
    ...
    function R(l) {
        for (var n = l.f.length, u = 0; u < n; ++u) {
            ...
            if (-1 != i.indexOf("|")) e = !1;
                ...
                i = i.replace(rl, "\\d"), i = i.replace(il, "\\d"), d(e.m);
                var a;
                a = e;
                var r = p(r, 2),
                    o = "999999999999999".match(i)[0];
                o.length < a.a.b.length ? a = "" : (a = o.replace(new RegExp(i, "g"), r), a = a.replace(RegExp("9", "g"), " ")), 0 < a.length ? (e.m.a(a), e = !0) : e = !1
            }
            if (e) return l.w = t, l.B = ol.test(f($, 4)), l.s = 0, !0
        }
        return l.l = !1
    }

    function I(l, n) {
        for (var u = [], d = n.length - 3, $ = l.f.length, t = 0; t < $; ++t) {
            var e = l.f[t];
    ...
    function K(l, n) {
        l.i.a(n);
        var u = n;
        if ($l.test(u) || 1 == l.i.b.length && dl.test(u)) {
            var $, u = n;
            "+" == u ? ($ = u, l.u.a(u)) : ($ = ul[u], l.u.a($), l.a.a($)), n = $
        } else l.l = !1, l.F = !0;
        if (!l.l) {
            if (!l.F)
                if (U(l)) {
                    if (O(l)) return L(l)
                } else if (0 < l.h.length && (u = l.a.toString(), d(l.a), l.a.a(l.h), l.a.a(u), u = l.b.toString(), $ = u.lastIndexOf(l.h), d(l.b), l.b.a(u.substring(0, $))), l.h != H(l)) return l.b.a(" "), L(l);
            return l.i.toString()
        }
        switch (l.u.b.length) {
            case 0:
    ...
    function L(l) {
        return l.l = !0, l.A = !1, l.f = [], l.s = 0, d(l.m), l.w = "", F(l)
    }
    ...
    function _(l) {
        for (var n = l.a.toString(), u = l.f.length, d = 0; d < u; ++d) {
            var $ = l.f[d],
                t = p($, 1);
            if (new RegExp("^(?:" + t + ")$").test(n)) return l.B = ol.test(f($, 4)), n = n.replace(new RegExp(t, "g"), f($, 2)), P(l, n)
        }
        return ""
    }
    ...
    function F(l) {
        var n = l.a.toString();
        if (3 <= n.length) {
            for (var u = l.o && 0 == l.h.length && 0 < c(l.g, 20) ? s(l.g, 20) || [] : s(l.g, 19) || [], d = u.length, $ = 0; $ < d; ++$) {
                var t = u[$];
                0 < l.h.length && T(p(t, 4)) && !f(t, 6) && null == t.a[5] || (0 != l.h.length || l.o || T(p(t, 4)) || f(t, 6)) && al.test(p(t, 2)) && l.f.push(t)
            }
            return I(l, n), n = _(l), 0 < n.length ? n : R(l) ? D(l) : l.i.toString()
        }
        return P(l, n)
    }
    ...
    function D(l) {
        var n = l.a.toString(),
            u = n.length;
        if (0 < u) {
            for (var d = "", $ = 0; $ < u; $++) d = V(l, n.charAt($));
            return l.l ? P(l, d) : l.i.toString()
        }
        return l.b.toString()
    }
    ...
    function H(l) {
        var n, u = l.a.toString(),
            $ = 0;
        return 1 != f(l.g, 10) ? n = !1 : (n = l.a.toString(), n = "1" == n.charAt(0) && "0" != n.charAt(1) && "1" != n.charAt(1)), n ? ($ = 1, l.b.a("1").a(" "), l.o = !0) : null != l.g.a[15] && (n = new RegExp("^(?:" + f(l.g, 15) + ")"), n = u.match(n), null != n && null != n[0] && 0 < n[0].length && (l.o = !0, $ = n[0].length, l.b.a(u.substring(0, $)))), d(l.a), l.a.a(u.substring($)), u.substring(0, $)
    }
    ...
    function U(l) {
        var n = l.u.toString(),
            ...
            u = n.match(u);
        return null != u && null != u[0] && 0 < u[0].length && (l.o = !0, u = u[0].length, d(l.a), l.a.a(n.substring(u)), d(l.b), l.b.a(n.substring(0, u)), "+" != n.charAt(0) && l.b.a(" "), !0)
    }
        ...
        l: {
            if (n = l.a.toString(), 0 != n.length && "0" != n.charAt(0))
                for (var t, e = n.length, r = 1; 3 >= r && r <= e; ++r)
                    if (t = parseInt(n.substring(0, r), 10), t in ll) {
                        $.a(n.substring(r)), n = t;
                        break l
                    }
            n = 0
    ...
    function V(l, n) {
        ...
        if (0 <= u.substring(l.s).search(l.H)) {
            var $ = u.search(l.H),
                u = u.replace(l.H, n);
            return d(l.m), l.m.a(u), l.s = $, u.substring(0, l.s + 1)
        }
    ...
    o.prototype.set = function(l, n) {
        ...
        return l != this && (l.a = {}, l.b && (l.b = {}), C(l, this)), l
    }, n(S, o);
    var j = null;
    n(M, o);
    var q = null;
    ...
    }, S.j = S.prototype.j, M.prototype.j = function() {
        var l = q;
        return l || (q = l = g(M, {
            0: {
    ...
    }, M.j = M.prototype.j, A.prototype.j = function() {
        var l = k;
        return l || (k = l = g(A, {
            0: {
                name: "PhoneMetadata",
    ...
    }, A.j = A.prototype.j, m.prototype.a = function(l) {
        throw new l.b, Error("Unimplemented")
    }, m.prototype.b = function(l, n) {
    ...
    var z = /^-?[0-9]+$/;
    n(b, m), b.prototype.a = function(l, n) {
        var u = new l.b;
        return u.g = this, u.a = n, u.b = {}, u
    }, n(G, b), G.prototype.b = function(l, n) {
        return 8 == l.a ? !!n : m.prototype.b.apply(this, arguments)
    }, G.prototype.a = function(l, n) {
        return G.M.a.call(this, l, n)
    };
    /*
    ...
    */
    ...
    E.prototype.K = function() {
        this.C = "", d(this.i), d(this.u), d(this.m), this.s = 0, this.w = "", d(this.b), this.h = "", d(this.a), this.l = !0, this.A = this.o = this.F = !1, this.f = [], this.B = !1, this.g != this.J && (this.g = v(this, this.D))
    }, E.prototype.L = function(l) {
        return this.C = K(this, l)
    }, l("Cleave.AsYouTypeFormatter", E), l("Cleave.AsYouTypeFormatter.prototype.inputDigit", E.prototype.L), l("Cleave.AsYouTypeFormatter.prototype.clear", E.prototype.K)
