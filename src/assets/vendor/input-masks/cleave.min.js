...
! function(e, t) {
    ...
    return function(e) {
            ...
            i.prototype = {
                ...
                getRawValue: function() {
                    var e = this,
                        ...
                        r = i.Util,
                        n = e.element.value;
                    return t.rawValueTrimPrefix && (n = r.getPrefixStrippedValue(n, t.prefix, t.prefixLength, t.result, t.delimiter, t.delimiters)), n = t.numeral ? t.numeralFormatter.getRawValue(n) : r.stripDelimiters(n, t.delimiter, t.delimiters)
                },
        ...
        var r = {
            ...
            getPrefixStrippedValue: function(e, t, r, i, n, a) {
                if (0 === r) return e;
                if (i.slice(0, r) !== t) return "";
                var o = this.stripDelimiters(i, n, a);
