            ...
            return a(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    if (s.globals.markers.size[e] > 0 && (o = l.group({
                        ...
                        })).attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")), n.x instanceof Array)
        ...
        Y = function() {
            ...
            return a(t, [{
                ...
                value: function() {
                    ...
                    if ("bar" !== e && "rangeBar" !== e && "bubble" !== e)
                        for (var i = t.globals.dom.baseEl.querySelectorAll(".apexcharts-datalabels text"), a = 0; a < i.length; a++) {
                            var s = i[a],
                                r = s.getBBox(),
                                n = null;
                ...
                value: function(t) {
                    ...
                    i.map((function(t, e) {
                        o.globals.axisCharts ? function(t, e) {
                            if (h.push(t.name), (l = []).push("x"), l.push("y"), h.push(l.join(s)), t.data && t.data.length)
            ...
            return a(t, [{
                ...
                value: function(t, e) {
                    ...
                    if (void 0 !== i.config.grid.column.colors && i.config.grid.column.colors.length > 0)
                        for (var l = "category" === i.config.xaxis.type || i.config.xaxis.convertedCatToNumeric ? t - 1 : t, h = i.globals.padHorizontal, c = i.globals.padHorizontal + i.globals.gridWidth / l, d = i.globals.gridHeight, g = 0, u = 0; g < t; g++, u++) u >= i.config.grid.column.colors.length && (u = 0), this._drawGridBandRect({
                            c: u,
                            x1: h,
                            y1: 0,
                            x2: c,
            ...
            return a(t, [{
                    ...
                    if (t.minY = r.minY, t.maxY = r.maxY, i = r.lowestY, e.chart.stacked) {
                        ...
                        if (t.series.length)
                            for (var l = 0; l < t.series[t.maxValsInArrayIndex].length; l++)
                                for (var h = 0, c = 0, d = 0; d < t.series.length; d++) null !== t.series[d][l] && g.isNumber(t.series[d][l]) && (t.series[d][l] > 0 ? h = h + parseFloat(t.series[d][l]) + 1e-4 : c += parseFloat(t.series[d][l])), d === t.series.length - 1 && (n.push(h), o.push(c));
                ...
                value: function() {
                    ...
                    if (t.isXNumeric)
                        for (var a = 0; a < t.series.length; a++)
                            if (t.labels[a])
                                for (var s = 0; s < t.labels[a].length; s++) null !== t.labels[a][s] && g.isNumber(t.labels[a][s]) && (t.maxX = Math.max(t.maxX, t.labels[a][s]), t.initialMaxX = Math.max(t.maxX, t.labels[a][s]), t.minX = Math.min(t.minX, t.labels[a][s]), t.initialMinX = Math.min(t.minX, t.labels[a][s]));
                        ...
                        var r = new P({}),
                            n = function() {
                                ...
                                if (n > a) {
                                    ...
                                    for (var l = 0; l < s.length; l++) n < s[l].breakpoint && (t = E.extendArrayProps(r, s[l].options), t = g.extend(i.config, t), e.overrideResponsiveOptions(t))
                            };
                        if (t) {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    var e = t.theme.mode || "light",
                        ...
                        a = t.chart.foreColor ? t.chart.foreColor : "dark" === e ? "#f6f7f8" : "#5e6973";
        ...
        at = function() {
            ...
            return a(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    if (e.total.show && s.globals.series.length > 1) this.printInnerLabels(e, e.total.label, e.total.formatter(s));
                    else {
                    ...
                    if (this.clientY = c, this.clientX = h, n.globals.capturedSeriesIndex = -1, n.globals.capturedDataPointIndex = -1, c < l.top || c > l.top + l.height) this.handleMouseOut(r);
                        ...
                        if (n.globals.isBarHorizontal && this.hasBars() && (f = !1), "mousemove" === s.type || "touchmove" === s.type || "mouseup" === s.type) {
                            ...
                            if (this.blyaxisTooltip)
                                for (var b = 0; b < n.config.yaxis.length; b++) this.axesTooltip.drawYaxisTooltipText(b, c, this.xyRatios);
                ...
                value: function(t, e) {
                    ...
                    for (var n = a.group({
                        ...
                        for (var w = a.group({
                            ...
                            var A, S = this.barHelpers.getStrokeWidth(o, k, x),
            ...
            return a(t, [{
                ...
                value: function(t, e) {
                    ...
                    var d = new Ct(this.ctx, e),
                        ...
                        b = [];
                    if (s.comboCharts) {
                        if (n.series.length > 0 && b.push(d.draw(n.series, "area", n.i)), h.series.length > 0)
                        ...
                        case "area":
                            ...
                            break;
                        case "bar":
                            if (a.chart.stacked) b = new mt(this.ctx, e).draw(s.series);
                            else b = new bt(this.ctx, e).draw(s.series);
                            break;
                        case "candlestick":
            ...
            a.PathArray = function(t, e) {
                ...
                if (-1 != s)
                    ...
                    for (e in a.listeners[s])
                        for (o in a.listeners[s][e]) n === o && a.off(t, [e, n].join("."));
                else if (r) {
                    if (a.listeners[s][r]) {
        ...
        function() {
            ...
            function a(t) {
                ...
                switch (t[0]) {
                    ...
                    case "A":
                        t = (e = function(t, e) {
                            var i, a, s, r, n, o, l, h, c, d, g, u, f, p, x, b, m, v, y, w, k, A, S, C, L, P, z = Math.abs(e[1]),
                                T = Math.abs(e[2]),
                                E = e[3] % 360,
                                M = e[4],
                                I = e[5],
                                ...
                                F = new SVG.Point(X, Y),
                                D = [];
                            if (0 === z || 0 === T || R.x === F.x && R.y === F.y) return [
                                ["C", R.x, R.y, F.x, F.y, F.x, F.y]
                            ];
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                return new Promise((function(s, r) {
                    ...
                    var o = new N(t.ctx),
                        l = new G(t.ctx);
                    if (null !== n && (o.xAxisLabelCorrections(n.xAxisTickWidth), l.setYAxisTextAlignments()), i.annotations = new S(i), "back" === a.config.annotations.position && i.annotations.drawAnnotations(), e.elGraph instanceof Array)
