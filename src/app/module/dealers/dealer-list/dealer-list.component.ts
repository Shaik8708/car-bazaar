...
export class DealerListComponent implements OnInit {
  ...
  getAllDealers() {
    ...
    this.baseApi.get(`${urlConfig.getAllPath}?collectionName=${urlConfig.dealer}`)
  ...
  getDealersByCity(id: any) {
    ...
    this.baseApi.get(`${urlConfig.getAllPath}?collectionName=${urlConfig.dealer}&cityName=${id?.value}`)
