...
@Component({
  selector: 'app-deal-accepted',
  templateUrl: './deal-accepted.component.html',
  styleUrls: ['./deal-accepted.component.css']
})
export class DealAcceptedComponent {
  ...
  getAllLeads(){
    ...
    this.spinner.show();
    this.api.getLeadsByStatus(params, "DealAccepted").subscribe((res:any) => {
