...
export class DealerQuotationLeadsComponent {
 loginType: any;
  ...
  userList1 = ["Car", 'Bike', 'Yamaha', 'Royal_Enfield', "Suzuki", "Mahindra", 'TVS', 'Bajaj', 'Honda', 'Hero', 'Other_Brand'
    , 'Ford', 'Nissan', 'Volkswagen', 'Chevrolet', 'Toyota', 'Honda', 'Hyundai', 'Mahindra', 'Tata', 'Renault', 'Ambassador', 'Mercedes', 'BMW', 'Datsun', 'Land_Rover', 'Bajaj', 'Maruthi', 'Skoda', 'Fiat', 'Mitsubishi', 'Opel', 'Other_Brand',
    'Mahindra', 'Swaraj', 'Massey_Ferguson', 'Sonalika', 'Powertrac', 'Eicher', 'John_Deere', 'Farmtrac', 'New_Holland', 'Kubota', 'Solis', 'Preet', 'VST', 'Indo Farm', 'Captain', 'ACE', 'Digitrac', 'Force', 'Trakstar', 'Hindustan', 'Kartar', 'Same Deutz Fahr', 'Escorts', 'Other_Brand',
    'Omni', 'Gypsy', 'Esteem', 'Baleno', 'Zen_Estilo', 'Ritz', 'Swift_Dzire', '1000', '800', 'Alto', 'Zen', 'Wagon_R', 'Versa', 'Swift', 'Ciaz', 'Ertiga', 'A_Star', 'S_Presso', 'Vitara', 'Breeza',
    'Sonata', 'Accent', 'Tucson', 'Terracan', 'Accent', 'i10', 'i20', 'Verna', 'Creta', 'Venue', 'Santro', 'Elantra', 'Santa_FE',
    'Jazz', 'City', 'Amaze', 'Accord', 'Civic', 'WR_V', 'Brio', 'BR_V', 'CR_V', 'Estate', 'Sierra', 'Sumo', 'Safari', 'Indica', 'Sumo_Grande', 'Vista', 'Nano', 'Manza', 'Aria', 'Zest', 'Bolt', 'Indigo', 'Indigo_Marina',
    'Beat', 'Tavera', 'Aveo', 'Optra', 'Sail', 'UVA', 'Cruze', 'Spark', 'Other_Model', 'Innova', 'Corolla', 'Fortuner', 'Etios',
    'Xylo', 'Scorpio', 'Bolero', 'Endeavour', 'Fusion', 'Figo', 'Ikon', 'Escort', 'Mondeo', 'Fiesta', 'EcoSport', 'Aspire',
    'Kicks', 'Sunny', 'Micra', 'Magnite', 'Vento', 'Jetta', 'Tiguan', 'Polo', 'Rapid', 'Fabia', 'Laura', 'Superb', 'Octavia', 'Palio', 'Punto', 'Uno', 'Siena', 'Evo', 'Premier_118', 'Linea', 'Padmini', 'Cedia', 'Challenger', 'Pajero', 'Lancer', 'Montero',
    'Astra', 'Vectra', 'Corsa', 'Duster', 'Contessa', 'Ambassador', '300_D', 'Benz_C', , 'C_200', 'Benz_S', 'Benz_E', '525', 'M_5', 'Datsun_Go', 'Redi_Go',
    'Defender', 'Discovery', 'Range_Rover', 'Qute', 'Auto', 'Mastro', 'Xtreme', 'Splender', 'Passion', 'Pleasure', 'Maestro', 'Super_Splender', 'Hf_Deluxe', 'CBZ', 'Glamour', 'Destini', 'X_Pulse',
    'Jupitor', 'Rider', 'i_Qube_EV', 'Radeon', 'Apache', 'XL_100', 'Super_XL', 'Fiero', 'Victor', 'N_Torq', 'Scooty_Pep', 'Star_City', 'Sport', 'Scooty_Zest', 'Platina', 'CT_100', 'Dominar', 'Avenger', 'Pulsar', 'Priya', 'CUB', 'Discover', 'Chetak',
    'CB_(Series)', 'Aviator', 'Eterno', 'Unicorn', 'Livo', 'Shine', 'Grazia', 'SP', 'X_Blade', 'Hornet', 'CD_100', 'Dio', 'Activa', 'CB_200', 'HNESS', 'Kinetic', 'CRB_(Series)',
    'Aerox', 'Fazer', 'FZ', 'RX_100', 'Libero', 'R_15', 'Ray_ZR', 'Fascino', 'Fiero', 'Heat', 'Gixxer', 'Access_125', 'Burgman', 'Avenis', "Samuri", 'Shogun',
    'Thunderbird', 'Bullet_350cc', 'Bullet_500cc', 'RoyalEnfield', 'Rodeo', 'Mojo', "Gusto", 'Centuro', 'Mahindra_575_DI', "Mahindra_Arjun_555_DI",
    'Petrol', 'Diesel', 'Petrol_CNG', 'Alloy_Mag_Wheel', 'Spoxes_Wheel', 'Drum_Wheel', 'Running', 'Not_Running', 'Bangalore', 'Delhi', 'Delhi NCR', "Kolkata", "Indore", "Chennai", "Ahmedabad",
    'Jaipur',
    'Mumbai',
    'Pune',
    'Patna',
    ...
    'Surat', 'Vadodara',
    'Nagpur', 'Agra', 'Bhopal',
    'Vizag', 'Secunderabad', 'Guntur',
    'Coimbatore', 'Madurai',
    'Raipur', 'Ranchi', 'Bilaspur', 'Howrah'
  ...
  constructor(private api: ApiService, private _activated: ActivatedRoute, private paginationService: PaginationService, private toastr: ToastrService, private router: Router, private spinner: NgxSpinnerService,
  ...
  phoneNumber() {
    ...
    this.api.getNewFormDataByPh(params, this.phoneNo).subscribe((res: any) => {
  ...
  getByDate(date: any) {
    ...
    this.api.getNewFormDataBydate(params, date?.value).subscribe((res: any) => {
      if (res?.data?.length != 0) {
        this.pagination = this.paginationService.getPager(
          res?.totals?.count,
          this.currentPage,
  ...
  getAllLeads(data?: any, tele?: any) {
    ...
    this.originalCreatedDateSelected = localStorage.getItem('searchByoriginalCreatedDate');
    ...
    //   limit: this.currentPageLimit,
    // };
    let query = data ? `&userName=${data}&modelName=${data}&brandName=${data}&uniqueProductName=${data}` : ""
    let customSelectedDates = this.startDate && this.endDate ? `&startDate=${this.convertedStartDate}&endDate=${this.convertedEndDate}` : ""
    let teleCaller = tele && tele != 'null' ? `&teleCaller=${tele}` : "";
    let phoneNumber = this.phoneNoSearch && this.phoneNoSearch != 'null' ? `&phoneNumber=${this.phoneNoSearch}` : "";
    let byDate = this.createdDate && this.createdDate != 'null' ? `&createdDate=${this.createdDate}` : "";

    this._activated.paramMap.subscribe(params => {
      this.myLeadsId = params.get('id') && params.get('id') != 'null' ? `&teleCallerData.id=${params.get('id')}` : "";
    });

    const collectionName = this.apiUrlFromOther ? `?collectionName=${this.apiUrlPathFromOther}` : `?collectionName=${urlConfig.products}`
  ...
  getAllLeadsWithParametrs() {
    ...
    this.spinner.show();
    this.api.getLeadWithVehiclePicture(params, 'vp').subscribe((res: any) => {
  ...
  updateList(data: any, teleCallerStatus: any) {
    ...
    this.baseApi.patch(urlConfig.updatePath + data._id, data)
      .pipe(
        finalize(async () => {
  ...
  onDateChange(event: any) {
    ...
    localStorage.setItem('searchByoriginalCreatedDate', this.originalCreatedDateSelected);
