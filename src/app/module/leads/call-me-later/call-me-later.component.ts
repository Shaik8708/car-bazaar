...
@Component({
  selector: 'app-call-me-later',
  templateUrl: './call-me-later.component.html',
  styleUrls: ['./call-me-later.component.css']
})
export class CallMeLaterComponent {
  ...
  getAllLeads(){
    ...
    this.spinner.show();
    this.api.getLeadsByStatus(params, "CallMeLater").subscribe((res:any) => {
