...
@Component({
  selector: 'app-deal-cancelled',
  templateUrl: './deal-cancelled.component.html',
  styleUrls: ['./deal-cancelled.component.css']
})
export class DealCancelledComponent {
  ...
  getAllLeads(){
    ...
    this.spinner.show();
    this.api.getLeadsByStatus(params, "DealCancelled").subscribe((res:any) => {
