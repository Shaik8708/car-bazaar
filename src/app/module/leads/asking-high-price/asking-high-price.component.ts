...
@Component({
  selector: 'app-asking-high-price',
  templateUrl: './asking-high-price.component.html',
  styleUrls: ['./asking-high-price.component.css']
})
export class AskingHighPriceComponent {
  ...
  getAllLeads(){
    ...
    this.spinner.show();
    this.api.getLeadsByStatus(params, "AskingHighPrice").subscribe((res:any) => {
